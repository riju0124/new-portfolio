  ...
  return (
    <nav
      className={`${
        ...
        scrolled ? "bg-[rgba(13,20,18,0.82)] backdrop-blur-xl border-b border-white/5" : "bg-transparent"
      }`}
    >
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        >
          ...
          <p className='text-white text-[18px] font-bold cursor-pointer flex tracking-[-0.02em]'>
            Riju &nbsp;
            <span className='sm:block hidden text-[#d8d0c4]'> | developer portfolio</span>
          </p>
        </Link>
